! function(e) {
    var t = function(e, t, a) {
        ...
        if (function() {
                ...
                for (t in i = e.lazySizesConfig || e.lazysizesConfig || {}, a) t in i || (i[t] = a[t])
        ...
        var o = t.documentElement,
            ...
            C = function(e, t, a) {
                ...
                a && C(e, t), y.forEach(function(a) {
                    e[n](a, t)
                })
            },
            b = function(e, a, i, o, r) {
                var s = t.createEvent("Event");
                return i || (i = {}), i.instance = n, s.initEvent(a, !o, !r), s.detail = i, e.dispatchEvent(s), s
            },
            A = function(t, a) {
                var n;
                !r && (n = e.picturefill || i.pf) ? (a && a.src && !t[l]("srcset") && t.setAttribute("srcset", a.src), n({
                    reevaluate: !0,
                    elements: [t]
                })) : a && a.src && (t.src = a.src)
            },
            ...
            w = function() {
                var e, a, n = [],
                    ...
                    r = function() {
                        var t = o;
                        for (o = n.length ? i : n, e = !0, a = !1; t.length;) t.shift()();
                        e = !1
                    },
                    s = function(n, i) {
                        e && !i ? n.apply(this, arguments) : (o.push(n), a || (a = !0, (t.hidden ? d : u)(r)))
                    };
            ...
            x = function() {
                var r, f, y, z, _, x, S, B, T, F, R, D, k = /^img$/i,
                    H = /^iframe$/i,
                    ...
                    j = function(e, a) {
                        var n, i = e,
                            r = U(e);
                        for (B -= a, R += a, T -= a, F += a; r && (i = i.offsetParent) && i != t.body && i != o;)(r = (E(i, "opacity") || 1) > 0) && "visible" != E(i, "overflow") && (n = i.getBoundingClientRect(), r = F > n.left && T < n.right && R > n.top - 1 && B < n.bottom + 1);
                        return r
                    },
                    G = function() {
                        ...
                        if ((z = i.loadMode) && $ < 8 && (e = C.length)) {
                            for (a = 0, q++; a < e; a++)
                                if (C[a] && !C[a]._lazyRace)
                                    ...
                                    else if ((y = C[a][l]("data-expand")) && (u = 1 * y) || (u = P), v || (v = !i.expand || i.expand < 1 ? o.clientHeight > 500 && o.clientWidth > 500 ? 500 : 370 : i.expand, n._defEx = v, g = v * i.expFactor, p = i.hFac, D = null, P < g && $ < 1 && q > 2 && z > 2 && !t.hidden ? (P = g, q = 0) : P = z > 1 && q > 1 && $ < 6 ? v : 0), h !== u && (x = innerWidth + u * p, S = innerHeight + u, m = -1 * u, h = u), s = C[a].getBoundingClientRect(), (R = s.bottom) >= m && (B = s.top) <= S && (F = s.right) >= m * p && (T = s.left) <= x && (R || F || T || B) && (i.loadHidden || U(C[a])) && (f && $ < 3 && !y && (z < 3 || q < 4) || j(C[a], u))) {
                                if (Z(C[a]), d = !0, $ > 9) break
                            } else !d && f && !c && $ < 4 && q < 4 && z > 2 && (r[0] || i.preloadAfterLoad) && (r[0] || !y && (R || F || T || B || "auto" != C[a][l](i.sizesAttr))) && (c = r[0] || C[a]);
                            c && !d && Z(c)
                        }
                    },
                    J = N(G),
                    ...
                    Y = M(function(e, t, a, n, o) {
                        var r, s, c, u, f, z;
                        (f = b(e, "lazybeforeunveil", t)).defaultPrevented || (n && (a ? g(e, i.autosizesClass) : e.setAttribute("sizes", n)), s = e[l](i.srcsetAttr), r = e[l](i.srcAttr), o && (u = (c = e.parentNode) && m.test(c.nodeName || "")), z = t.firesLoad || "src" in e && (s || r || u), f = {
                            target: e
                        }, g(e, i.loadingClass), z && (clearTimeout(y), y = d(I, 2500), C(e, V, !0)), u && h.call(c.getElementsByTagName("source"), X), s ? e.setAttribute("srcset", s) : r && !u && (H.test(e.nodeName) ? function(e, t) {
                            var a = e.getAttribute("data-load-mode") || i.iframeLoadMode;
                            0 == a ? e.contentWindow.location.replace(t) : 1 == a && (e.src = t)
                        }(e, r) : e.src = r), o && (s || u) && A(e, {
                            src: r
                        })), e._lazyRace && delete e._lazyRace, p(e, i.lazyClass), w(function() {
                            var t = e.complete && e.naturalWidth > 1;
                            z && !t || (t && g(e, i.fastLoadedClass), K(f), e._lazyCache = !0, d(function() {
                    ...
                    ae = function() {
                        f || (a.now() - _ < 999 ? d(ae, 999) : (f = !0, i.loadMode = 3, J(), c("scroll", te, !0)))
                    };
                return {
                    _: function() {
                        _ = a.now(), n.elements = t.getElementsByClassName(i.lazyClass), r = t.getElementsByClassName(i.lazyClass + " " + i.preloadClass), c("scroll", J, !0), c("resize", J, !0), c("pageshow", function(e) {
                            if (e.persisted) {
                            ...
                            subtree: !0,
                            attributes: !0
                        }) : (o[s]("DOMNodeInserted", J, !0), o[s]("DOMAttrModified", J, !0), setInterval(J, 999)), c("hashchange", J, !0), ["focus", "mouseover", "click", "load", "transitionend", "animationend"].forEach(function(e) {
                            t[s](e, J, !0)
                        }), /d$|^c/.test(t.readyState) ? ae() : (c("load", ae), t[s]("DOMContentLoaded", J), d(ae, 2e4)), n.elements.length ? (G(), w._lsFlush()) : J()
                    },
                    checkElems: J,
                    unveil: Z,
                    _aLSL: te
            ...
            W = function() {
                var e, a = M(function(e, t, a, n) {
                    ...
                    n = function(e, t, n) {
                        ...
                        o && (n = _(e, o, n), (i = b(e, "lazybeforesizes", {
                            width: n,
                            dataAttr: !!t
            ...
            S = function() {
                !S.i && t.getElementsByClassName && (S.i = !0, W._(), x._())
            };
        return d(function() {
            i.init && S()
        }), n = {
