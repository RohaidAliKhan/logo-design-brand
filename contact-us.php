<?php include 'includes/header.php'; ?>
   ...
   <title>Submit a request | Contact Us | <?php echo WEBSITE_NAME; ?> | <?php echo PHONE; ?></title>
   <meta name="description" content="<?php echo WEBSITE_NAME; ?>: Dallas's top logo design company. Crafting high-quality logos for brands, companies, and startups of all sizes">
</head>

   <body>
      <?php include 'includes/menu.php'; ?>
      
      <section class="contact_main__IrjCv">
         <div class="container">
            <div class="contact_main-info__33fzu">
               <h1>Contact Us</h1>
               <p>Let’s get connected to transform your creative idea into a success story. Believing is Achieving, and your trust in us can let you achieve way beyond what you wish for. We are available 24/7 for your assistance. Give us a call, email, or message for a swift response.</p>
            </div>
         </div>
      </section>
      <section class="ContactFrom_form-sec__xH6rO">
         <div class="ContactFrom_form-grid__Uzwza">
            <div class="ContactFrom_left-info__v7Iu8">
               <div class="ContactFrom_box-grid__HQzCU">
                  <h2>9.7k+</h2>
                  <p>Very satisfied clients <br>around the worldwide.</p>
               </div>
            </div>
      ...
      <section class="contact_main-map__o0Zsx">
         <div class="container">
            <div class="contact_map-info__ZUzM1">
               ...
               <a class="primary-button_btn" target="_blank" href="https://g.page/r/CTgHxbNZ-JpGEBM/">VIEW LARGER MAP</a>
